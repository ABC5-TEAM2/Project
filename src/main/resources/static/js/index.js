 "https://maps.googleapis.com/maps/api/js?key=AIzaSyD_FL3IrY7I_w7Cerf1pK28nSvyxby86Xg&callback=getDb()" >
	    ...
	    function getTourist_Spot(){
	    	let tourist_Spot_id ;
	    	
	         $.ajax({
	           url: "/tourist_Spot/" +tourist_Spot_id,
	           type: "post",
   	...
   	//// data1에 정보가 있으면 지도에 띄우게 해서 마커로 길찾기 기능
 	   console.log(data1);
